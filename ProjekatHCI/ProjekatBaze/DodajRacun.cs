...
namespace ProjekatBaze
{
    ...
    {
        private PrikazR otac;
        public String id, Datum, Cena, idKase;
        public DodajRacun(PrikazR pOtac)
        {
            InitializeComponent();
            otac = pOtac;
        }
        ...
        {
            string sql = "SELECT * FROM `benzinska_pumpa`.`kasa`";
            ...
            if (id != null)
            {
                comboBox1.SelectedValue = idKase;
            }
            else
        ...
        {
            if (textBox1.Text.Trim().Length < 1 || textBox2.Text.Trim().Length < 3 || textBox3.Text.Trim().Length < 1
            ...
            {
                Racun ra = new Racun(textBox1.Text.Trim(), textBox2.Text.Trim(),
                   textBox3.Text.Trim(), comboBox1.SelectedValue.ToString());
                ObradaRacuna.izmjenaRacuna(ra, id);
                ocisti();
            }
            ...
            if (button2.Text == "dodaj" || button2.Text == "add")
            {
                Racun ra = new Racun(textBox1.Text.Trim(), textBox2.Text.Trim(),
                   textBox3.Text.Trim(), comboBox1.SelectedValue.ToString());
                ObradaRacuna.dodavanjeRacuna(ra);
                ocisti();
            }
            this.Close();
            otac.Display();
        ...
        public void IzmjenaInfo()
        {
            ...
            if (currCulture.Name == "en")
            {
                ...
                label1.Text = "change of account";
                button2.Text = "update";
            }
            else
            {
                label1.Text = "izmjena racuna";
        ...
        public void DodavanjeInfo()
        {
            ...
            if (currCulture.Name == "en")
            {
                ...
                label1.Text = "adding a bill";
                button2.Text = "add";
            }
            else
            {

                label1.Text = "dodavanje racuna";
                button2.Text = "dodaj";
            }
            }
        }
